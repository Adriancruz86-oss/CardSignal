...
grant select on public.market_snapshots, public.market_sales, public.signal_events to authenticated;
grant all on public.market_scan_runs, public.market_snapshots, public.market_sales, public.signal_events to service_role;
grant usage, select on sequence public.market_sales_id_seq to service_role;
