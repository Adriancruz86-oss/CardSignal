...
export default function TopToolsNavLayer(){
 ...
 .cs-pulse-launch,.cs-signal-lab-launch,.cs-sources-launch,.cs-live-launch,.cs-catalyst-launch,.cs-discovery-launch,.cs-market-scout-launch,.cs-pop-alert-launch,.cs-segment-launch,.cs-opportunity-launch,.cs-journal-launch,.cs-ac-launch{display:none!important}
